import calculate from '../routes/Calculator/logic/calculate.js';
...
describe('Testing calculate.js', () => {
    ...
    test('Create an empty object with AC button ', () => {
        let buttonName = 'AC';
        let obj = calculate(({ total: '', next: '', operation: '' }), buttonName);
    ...
    test('Test + button ', () => {
        let buttonName = '+';
        let obj = calculate(({ total: '2', next: '3', operation: '+' }), buttonName);
    ...
    test('Test - button ', () => {
        let buttonName = '-';
        let obj = calculate(({ total: '3', next: '2', operation: '-' }), buttonName);
    ...
    test('Test x button ', () => {
        let buttonName = 'x';
        let obj = calculate(({ total: '2', next: '3', operation: 'x' }), buttonName);        
    ...
    test('Test division by 0', () => {
        let buttonName = '÷';
        let obj = calculate(({ total: '8', next: '0', operation: '÷' }), buttonName);        
